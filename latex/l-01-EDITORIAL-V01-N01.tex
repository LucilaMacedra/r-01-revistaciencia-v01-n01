...
\renewcommand{\articuloautores}{Macedra Lucila}
\renewcommand{\articulotipo}{EDITORIAL}
\renewcommand{\articulorevista}{r-01-revistaciencia-v01-n01.md}
...
{\bfseries\color{azulrevista}Macedra Lucila}\par
\vspace{6pt}
{\bfseries\color{azulrevista!70}Derechos de autor\'ia:}\par
\textcopyright\ 2026 Lucila, M. Publicado por r-01-revistaciencia-v01-n01.md. \par\vspace{6pt}
{\bfseries\color{azulrevista!70}Publicación:} 2026\par\vspace{6pt}
\end{minipage}%
}% FIN GRUPO leftskip
\end{textblock*}
